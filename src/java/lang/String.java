 ...
 *
 * String类包含一些方法，这些方法可以检查序列中的各个字符，比较字符串，
 * 搜索字符串，提取子字符串以及创建字符串的副本，并将所有字符都转换为大写或小写。
 ...
 * 有关字符串连接和转换的更多信息，请参见Gosling，Joy和Steele， Java语言规范。
 *
 * 除非另有说明，否则将null参数传递给此类中的构造函数或方法将导致引发NullPointerException 。
 * String表示采用UTF-16格式的字符串，其中补充字符由代理对表示（有关更多信息，请参见Character类中的Unicode字符表示部分）。 索引值引用char代码单位，因此，补充字符在String使用两个位置。
...
public final class String implements java.io.Serializable, Comparable<String>, CharSequence {
    /**
     * String底层是使用字符数组存储的
     * StringBuffer（线程安全）、Builder底层使用了byte
     * final类型，初始化后就不能再修改
     */
